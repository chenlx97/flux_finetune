...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default="/data/clx/control-lora-v2-master/ckpt/FLUX.2-klein-base-9B",
        # default="/data/clx/control-lora-v2-master/ckpt/FLUX.2-klein-base-4B",
        # default="/data/clx/control-lora-v2-master/ckpt/FLUX.2-klein-4B",
        # default="/data/clx/control-lora-v2-master/ckpt/FLUX.2-klein-9B",
        required=False,
    ...
    parser.add_argument(
        "--instance_data_dir",
        type=str,
        default="/data/clx/data/wenli_data/tile_flux2_klein/resolution512",
    ...
    parser.add_argument(
        "--instance_prompt",
        type=str,
        default="修复扭曲的建筑立面纹理，使纹理自然、清晰、结构不变",
        # default=None,
        required=False,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/data/clx/tmp/flux-dreambooth-lora",
    ...
    parser.add_argument(
        ...
        type=str,
        default="1024,1024;768,1360;1360,768;880,1168;1168,880;1248,832;832,1248",
        help=(
...
class BucketBatchSampler(BatchSampler):
    ...
    def __len__(self):
        total = 0
        for bucket_idx in self.dataset.bucket_ids:
            total += 1
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(models_to_accumulate):
                if train_dataset.custom_instance_prompts:
                    ...
                    prompt_embeds = base_prompt_embeds.repeat(num_repeat_elements, 1, 1)
                    text_ids = base_text_ids.repeat(num_repeat_elements, 1, 1)
        ...
        if accelerator.is_main_process:
            if args.validation_prompt is not None and epoch % args.validation_epochs == 0:
                ...
                for ids,img in enumerate(images):
                    img.save(os.path.join('flux_lora_train', f"{global_step}-{ids}.jpg"))
    ...
    if accelerator.is_main_process:
        ...
        if should_run_final_inference:
            ...
            if args.validation_prompt and args.num_validation_images > 0:
                ...
                for ids,img in enumerate(images):
                    img.save(os.path.join('flux_lora_train', f"final_{global_step}-{ids}.jpg"))
            del pipeline
            free_memory()
